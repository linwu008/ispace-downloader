...
Compress-Archive -LiteralPath 'dist\CourseNestHelper' -DestinationPath 'dist\CourseNestHelper-0.6.0-windows-x64.zip' -Force
Get-FileHash -LiteralPath 'dist\CourseNestHelper-0.6.0-windows-x64.zip' -Algorithm SHA256 | Format-List
